        ...
        <div className="grid grid-cols-2 gap-[30px] justify-between">
          <div>
            ...
            <div className="flex flex-col gap-[10px] mt-[10px]">
              <div className={` rounded-sm space-y-[2px] px-[8px] py-[10px] ${darkMode ? "bg-[#282D35] text-white" : "bg-[#EBF2FA]"}`}>
          ...
          <div
            key={index}
            className={` rounded-sm space-y-[2px] px-[8px] py-[10px] ${darkMode ? "bg-[#282D35] text-white" : "bg-[#EBF2FA]"}`} >
          ...
          <div className="grid grid-cols-2 gap-[30px] mt-[20px] py-[20px] px-[10px] justify-between">
            <div>
              <h3 className="text-[18px] font-medium"> Work Skills</h3>
              <div className="flex flex-wrap gap-[10px]  mt-[10px]">
                <span className={` rounded-sm py-[3px] px-[10px] ${darkMode ? "bg-[#282D35] text-white" : "bg-[#EBF2FA]"}`}>
                  HTML
                </span>
                  <span className={` rounded-sm py-[3px] px-[10px] ${darkMode ? "bg-[#282D35] text-white" : "bg-[#EBF2FA]"}`}>
                  CSS
